...
r3d::r3d(int width, int height)
{
    ...
    glewExperimental = true; // Needed in r3d profile
    if(glewInit() != GLEW_OK)
    {
    ...
    // Object
    Object o("assets/suzanne.obj", "assets/uvmap.dds", "shaders/diffuse_vert.vertexshader", "shaders/diffuse_frag.fragmentshader");
    ...
    bool res = loadObj("assets/suzanne.obj", indices, vertices, uvs, normals);
